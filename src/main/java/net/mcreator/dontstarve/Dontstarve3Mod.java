 ...
 *
 */
package net.mcreator.dontstarve;
...
@Mod("dontstarve3")
public class Dontstarve3Mod {
	public static final Logger LOGGER = LogManager.getLogger(Dontstarve3Mod.class);
	public static final String MODID = "dontstarve3";
