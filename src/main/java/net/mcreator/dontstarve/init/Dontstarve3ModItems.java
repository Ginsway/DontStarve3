...
public class Dontstarve3ModItems {
	...
	public static final RegistryObject<Item> CACTUS_MEAT = REGISTRY.register("cactus_meat", () -> new CactusMeatItem());
	public static final RegistryObject<Item> ROAST_CARROT = REGISTRY.register("roast_carrot", () -> new RoastCarrotItem());
	public static final RegistryObject<Item> CHEESE = REGISTRY.register("cheese", () -> new CheeseItem());
	public static final RegistryObject<Item> GRASS_SALAD = REGISTRY.register("grass_salad", () -> new GrassSaladItem());
	public static final RegistryObject<Item> DIRT_SALAD = REGISTRY.register("dirt_salad", () -> new DirtSaladItem());
	public static final RegistryObject<Item> HOT_MILK_BUCKET = REGISTRY.register("hot_milk_bucket", () -> new HotMilkBucketItem());
	public static final RegistryObject<Item> ROAST_CACTUS_MEAT = REGISTRY.register("roast_cactus_meat", () -> new RoastCactusMeatItem());
	public static final RegistryObject<Item> ROAST_REEDS = REGISTRY.register("roast_reeds", () -> new RoastReedsItem());
	public static final RegistryObject<Item> ROAST_WATERLILY = REGISTRY.register("roast_waterlily", () -> new RoastWaterlilyItem());
	public static final RegistryObject<Item> ROAST_VINE = REGISTRY.register("roast_vine", () -> new RoastVineItem());
	public static final RegistryObject<Item> ROAST_BROWN_MUSHROOM = REGISTRY.register("roast_brown_mushroom", () -> new RoastBrownMushroomItem());
	public static final RegistryObject<Item> ROAST_RED_MUSHROOM = REGISTRY.register("roast_red_mushroom", () -> new RoastRedMushroomItem());
	public static final RegistryObject<Item> ROAST_WHEAT_SEED = REGISTRY.register("roast_wheat_seed", () -> new RoastWheatSeedItem());
	public static final RegistryObject<Item> ROAST_MELON_SEED = REGISTRY.register("roast_melon_seed", () -> new RoastMelonSeedItem());
	public static final RegistryObject<Item> ROAST_PUMPKIN_SEED = REGISTRY.register("roast_pumpkin_seed", () -> new RoastPumpkinSeedItem());
	public static final RegistryObject<Item> SOAK_ROTTEN_FLESH = REGISTRY.register("soak_rotten_flesh", () -> new SoakRottenFleshItem());
	public static final RegistryObject<Item> SOAK_SPIDER_EYE = REGISTRY.register("soak_spider_eye", () -> new SoakSpiderEyeItem());
	public static final RegistryObject<Item> SOAK_BONE = REGISTRY.register("soak_bone", () -> new SoakBoneItem());
	public static final RegistryObject<Item> SOAK_ENDER_PEARL = REGISTRY.register("soak_ender_pearl", () -> new SoakEnderPearlItem());
	public static final RegistryObject<Item> ROAST_ROTTEN_FLESH = REGISTRY.register("roast_rotten_flesh", () -> new RoastRottenFleshItem());
	public static final RegistryObject<Item> ROAST_SPIDER_EYE = REGISTRY.register("roast_spider_eye", () -> new RoastSpiderEyeItem());
	public static final RegistryObject<Item> ROAST_BONE = REGISTRY.register("roast_bone", () -> new RoastBoneItem());
	public static final RegistryObject<Item> ROAST_ENDER_PEARL = REGISTRY.register("roast_ender_pearl", () -> new RoastEnderPearlItem());
	public static final RegistryObject<Item> SOAK_GUNPOWDER = REGISTRY.register("soak_gunpowder", () -> new SoakGunpowderItem());
	public static final RegistryObject<Item> ROAST_GUNPOWDER = REGISTRY.register("roast_gunpowder", () -> new RoastGunpowderItem());
	public static final RegistryObject<Item> SLIME_FUDGE = REGISTRY.register("slime_fudge", () -> new SlimeFudgeItem());
	public static final RegistryObject<Item> MARSHMALLOWS = REGISTRY.register("marshmallows", () -> new MarshmallowsItem());
	public static final RegistryObject<Item> POPSICLE = REGISTRY.register("popsicle", () -> new PopsicleItem());
	public static final RegistryObject<Item> PAPER_CUP = REGISTRY.register("paper_cup", () -> new PaperCupItem());
	public static final RegistryObject<Item> ICE_CREAM = REGISTRY.register("ice_cream", () -> new IceCreamItem());
	public static final RegistryObject<Item> COPPER_KNIFE = REGISTRY.register("copper_knife", () -> new CopperKnifeItem());
