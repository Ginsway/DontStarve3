...
public class ItemInit {
    ...
    public static final Item CUSTOM_ITEM = new Item(new FabricItemSettings());// 测试物品
    // 奶酪锭
    ...
    public static void init() {
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "custom_item"), CUSTOM_ITEM);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "cheese"), CHEESE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "copper_knife"), COPPER_KNIFE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "gold_knife"), GOLD_KNIFE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "iron_knife"), IRON_KNIFE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "diamond_knife"), DIAMOND_KNIFE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "netherite_knife"), NETHERITE_KNIFE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_carrot"), ROAST_CARROT);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_reeds"), ROAST_REEDS);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_waterlily"), ROAST_WATERLILY);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_vine"), ROAST_VINE);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_brown_mushroom"), ROAST_BROWN_MUSHROOM);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_red_mushroom"), ROAST_RED_MUSHROOM);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_wheat_seeds"), ROAST_WHEAT_SEEDS);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_melon_seeds"), ROAST_MELON_SEEDS);
        Registry.register(Registries.ITEM, new Identifier("dontstarve3", "roast_pumpkin_seeds"), ROAST_PUMPKIN_SEEDS);
